      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-center gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <h2 className=" mb-8 max-md:mb-4">The future has a diverse pool of investors.</h2>
            <p className="mb-11  max-md:mb-6">
            With a low cost of entry, we hope new investors will give real estate a try. We’ve made this as easy as possible:
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="dark:text-white">Invest without hassle </span>
              </li>
              <li className="flex items-center gap-x-2">
                ...
                <span className="dark:text-white"> Track and monitor online </span>
              </li>
              <li className="flex items-center gap-x-2 ">
                <span className=" shadow-icon  item-center relative flex justify-center rounded-full bg-white dark:bg-dark-200">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="30" viewBox="0 0 28 30" fill="none">
                ...
                <span className="dark:text-white"> Earn passive income </span>
              </li>
            </ul>
          </div>
        </div>
