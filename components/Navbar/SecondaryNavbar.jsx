...
const SecondaryNavbar = () => {
  ...
  return (
    <header>
      ...
      <div
        className={cn(
          "fixed left-0 top-0 z-[999] w-full bg-transparent transition-all duration-500 max-md:z-[500]",
          sticky ? "nav-sticky" : ""
        )}
      >
          ...
          <div className="nav-logo">
            <Link href="/">
              <Image
                src={menuData.logo}
                alt="logo"
                className="w-56 block dark:hidden"
                width={200}
                height={80}
              />
              <Image
                  ...
                  {menuItem.path ? (
                    <>
                      <Link
                        href={menuItem.path}
                        className={cn(
                          "flex items-center rounded-large border border-transparent px-5 py-[5px] font-Inter text-base font-medium leading-8 text-white transition-colors duration-500 hover:border-borderColor hover:bg-white hover:duration-500 dark:text-white dark:hover:border-borderColor/10 dark:hover:bg-dark-200 lg:px-4 xl:px-5",
                          pathname === menuItem.path ? "active" : ""
                        )}
                        onClick={() => setInnerMobileMenu(!innerMobileMenu)}
                      >
