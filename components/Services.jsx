...
const Services = ({ sectionDetails = true }) => {
  ...
  return (
    <section className="relative bg-white pb-[50px] pt-[50px] dark:bg-dark-300 sm:overflow-hidden my-[50px]">
        ...
        {sectionDetails && (
          <div className="mb-12 flex flex-col">
            <p className="section-tagline max-lg:text-center">
              WHY INVEST WITH HOMEVEST
            </p>
            <div className="block max-lg:text-center lg:flex flex-col max-w-[800px]">
              <h2 className=" max-lg:mb-5 text-[26px] md:text-[36px] lg:text-[54px]">
                Diversify Your Portfolio With Real Estate Investing
              </h2>
            </div>
          </div>
        )}
              ...
              >
                <div className="h-full rounded border border-dashed border-gray-100 p-10 dark:border-borderColor-dark max-lg:p-5">
                  ...
                  <Image
                    src={items.iconDark}
                    alt="service logo"
                    className="mb-6 dark:inline-block hidden"
                    width={40}
                    height={40}
                  />
