        ...
        <div className="grid grid-cols-12">
          <div className="max-md:col-span-full md:col-span-6">
            <div className="max-w-[550px]">
              ...
              <h2>Expanding the opportunity for 
Americans to invest in real estate
</h2>
            </div>
          </div>
          <div className="max-w-[590px] py-10 max-md:col-span-full md:col-span-6">
            <p>
            We know what the numbers say — <b>70% of Americans</b> want to invest in real estate but can’t afford to. Why? Because the cost of entry is too high.

We’re going to change this. With our real estate investing model, you don’t have to buy the whole property to make a return. There are <br/> 1B+ underserviced investors<br/> out there, and we’re the solution to spreading the wealth around.
